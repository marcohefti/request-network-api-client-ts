...
This reference supplements the OpenAPI spec with behavioural notes, prerequisites, and known quirks discovered while integrating the Request Network API through `@marcohefti/request-network-api-client`.
