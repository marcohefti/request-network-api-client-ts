...
- Legacy endpoints remain available via `client.payer.legacy` or the `@request-suite/request-api-client/v1/payer` barrel when older storefronts still target `/v1/payer`.
